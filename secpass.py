...
# Function to generate a stronger password suggestion based on the original
...
def main():
    parser = argparse.ArgumentParser(
        description="secpass: A CLI tool to analyze password strength and suggest improvements.",
        formatter_class=argparse.RawTextHelpFormatter
    )
    parser.add_argument(
        "-p", "--password",
        help="Password to analyze (if not provided, you'll be prompted securely)"
    )
    ...
    # Analyze the password strength with color
